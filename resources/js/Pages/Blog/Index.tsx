...
export default function Index({ posts = [] }: IndexProps) {
    return (
        <AppLayout>
            ...
            <PageBanner
                title="Our Blog"
                subtitle="Insights and guides for your home construction journey."
                            ...
                            {posts.map((post) => (
                                ...
                                >
                                    ...
                                    <div className="py-2 lg:pr-6">
                                        <div className="flex flex-wrap items-center gap-6 border-b border-brand-blue/10 pb-5 font-body text-sm text-muted-gray">
                                            <span className="flex items-center gap-2 font-semibold uppercase tracking-wider text-terracotta">
                                        ...
                                        <h2 className="mt-6 font-display text-3xl font-bold leading-tight text-charcoal sm:text-4xl">
                                            <Link
                                                href={`/blog/${post.slug}`}
                                                className="transition duration-300 hover:text-brand-blue"
                                            >
                                                {post.title}
                                            </Link>
                                        </h2>
